...
| 406 Admin Config UI + Riwayat HC | RTK-05, RTK-08 | in progress (2/3 plan: 406-01 riwayat BACKEND + 406-02 retake config UI ✅ — **RTK-05 ✓** card `ManagePackages` + binding `CreateAssessment`/`EditAssessment` + e2e 6/6 @5270; RTK-08 BELUM 100% [view drill-down mount di AssessmentMonitoringDetail = 406-03]) |
