...
- [ ] **DATA-02**: KKJ-IDP Mapping editor works (CRUD, bulk save, export) and data links correctly to CMP/Mapping view
- [ ] **DATA-03**: Silabus CRUD works and data links correctly to Plan IDP and Coaching Proton pages
