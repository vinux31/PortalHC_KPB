...
| 406 Admin Config UI + Riwayat HC | RTK-05, RTK-08 | in progress (1/3 plan: 406-01 riwayat BACKEND shipped — `RiwayatUnifier`+`RiwayatPercobaan` GET+`_RiwayatPercobaan` partial; RTK-08 BELUM 100% [view drill-down mount di AssessmentMonitoringDetail = 406-03], RTK-05 card = 406-02) |
