...
- [ ] 396-01-PLAN.md — Wave 1 (TDD lock): FAILING unit suite InjectExcelHelperTests (round-trip stable order, blank=omit, validation-reject) + DTO InjectExcelUploadResult/EssayTextRequired + VM Step5Method (INJ-10)
- [ ] 396-02-PLAN.md — Wave 2: InjectExcelHelper (GenerateTemplate 2-sheet + ParseMatrix, EF-free) + scope essay text-required D-05 (EssayTextRequired) → Wave 0 GREEN (INJ-10)
