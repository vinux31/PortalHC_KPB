...
**Plans:** 5 plans
  - [ ] 356-01-PLAN.md — AF-1 helper CoacheeEligibilityCalculator + 4 [Fact] + refactor GetEligibleCoachees per-unit [Wave 1]
  - [ ] 356-02-PLAN.md — AF-3 MarkMappingCompleted transaksi+IsActive=false+cascade; AF-6 catch duplikat spesifik; AF-4 komentar defer [Wave 2]
  - [ ] 356-03-PLAN.md — AF-5 notif reassign 3 recipient; AF-7 batch query progression-warning [Wave 3]
...
| 356. Audit Fix Assign Coach-Coachee (addon, off-theme) | 0/5 | Not started | - |
