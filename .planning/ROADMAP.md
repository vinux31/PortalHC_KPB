...
- [ ] **Phase 296: Data Foundation + GradingService Extraction** - Migrasi DB backward-compatible dan ekstraksi GradingService sebagai fondasi semua fase berikutnya
...
|-------|----------------|--------|-----------|
| 296. Data Foundation + GradingService Extraction | 0/? | Not started | - |
