...
- [ ] 413-01-PLAN.md — FlexibleParticipantLifecycleTests (xUnit lifecycle lintas-fase: add→start→soft-remove→guard IsParticipantRemoved→restore + Pre/Post pair + hard-delete row+UPA gone, SQLEXPRESS disposable, de-tautologis)
