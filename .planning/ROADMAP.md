...
| 418. Opsi Jawaban Dinamis 2–6 | 0/4 | Planned | FALSE | - |
...
- [ ] 418-01-PLAN.md — Wave-0 xUnit: validator max-6 (extend OptionValidationTests) + edit-shrink guard pure-logic (OptionShrinkGuard intersection) (OPT-03 + D-418-02) [wave 1, migration=FALSE, RED]
