...
### Phase 342: ManageOrganization Page Fixes
  ...
  - **Plans:** 3 plans (3 waves sequential strict, autonomous backend -> checkpoint frontend -> checkpoint test+UAT)
    - [ ] 342-01-PLAN.md — Wave 1 backend OrganizationController: dup-name per-parent (2 edit) + PreviewEditCascade read-only count A1 full-accuracy (ORG-TREE-02, 07)
