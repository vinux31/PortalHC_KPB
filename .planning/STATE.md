...
- Phase 367+368 added (2026-06-10): Delete Records Cascade Overhaul + Hygiene Lanjutan — dari brainstorm kasus "admin hapus assessment via Input Records sukses palsu, worker masih lihat" (repro live lokal + kasus Rino @Dev). 29 temuan terverifikasi adversarial 2x (13 akar+residu, 15 baru re-check, 1 impersonate → backlog 999.6). Kebijakan user: cascade penuh turunan renewal (BUKAN detach), preview konfirmasi no-blocker, online session bisa dihapus dari tab Input Records. Spec: `docs/superpowers/specs/2026-06-10-delete-input-records-full-cascade-design.md`. 368 depends 367.
