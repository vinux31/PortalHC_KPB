> **ARCHIVED MILESTONE v32.0 Manajemen Peserta** — shipped local 2026-06-17, audited PASSED (7/7 REQ). Closed manually 2026-06-19 (non-destruktif). Semua REQ di bawah SATISFIED — lihat `v32.0-MILESTONE-AUDIT.md`. Snapshot dari git `21b80df2`.
