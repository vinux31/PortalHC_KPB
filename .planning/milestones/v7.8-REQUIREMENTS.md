# Requirements Archive: v7.8 Dokumen KKJ & Alignment KKJ/IDP — Combine Menu
...
- [x] **UI-01**: Tiap section bagian di kedua tab diberi pemisah visual (border-top + margin) agar mudah dibedakan
- [x] **UI-02**: Kolom Tipe (badge PDF/Excel) rata tengah sejajar dengan header-nya
- [x] **UI-03**: Tab pertama di-rename menjadi "Kebutuhan Kompetensi Jabatan (KKJ)"
- [x] **UI-04**: Kolom Tanggal Upload dihapus dari tabel di kedua tab
- [x] **UI-05**: Empty state compact — tanpa icon besar, padding dikurangi
