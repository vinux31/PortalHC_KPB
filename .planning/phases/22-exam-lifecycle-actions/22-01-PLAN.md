...
Insert a close-date check AFTER the existing "Completed" status guard and BEFORE the `StartedAt == null` InProgress write:

```csharp
// Enforce exam window close date (LIFE-05 / DATA-03)
