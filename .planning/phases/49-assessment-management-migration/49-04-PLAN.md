...
```bash
grep -n "public.*CreateAssessment\|public.*EditAssessment\|public.*DeleteAssessment\|public.*ResetAssessment\|public.*AuditLog\|public.*MonitoringDetail" /c/Users/Administrator/Desktop/PortalHC_KPB/.claire/worktrees/terminal-a/Controllers/CMPController.cs
```
