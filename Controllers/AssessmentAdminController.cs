...
namespace HcPortal.Controllers
{
    ...
    public class AssessmentAdminController : AdminBaseController
    {
        ...
        {
            // Phase 999.17: body template diekstrak ke QuestionTemplateBuilder.Build (pure/EF-free, unit-testable
            // — termasuk DataValidation dropdown QuestionType + numeric Skor). Controller jadi delegasi tipis.
            // Whitelist type dinormalisasi di dalam Build (default "MC").
            using var workbook = QuestionTemplateBuilder.Build(type);
