...
namespace HcPortal.Migrations
{
    ...
    [Migration("20260302093959_AddKkjDynamicColumns")]
    partial class AddKkjDynamicColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HcPortal.Models.KkjColumn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("BagianId", "DisplayOrder");

                    b.HasIndex("BagianId", "Name")
                        .IsUnique();

                    b.ToTable("KkjColumns", (string)null);
                });
            ...
            modelBuilder.Entity("HcPortal.Models.KkjTargetValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("KkjColumnId");

                    b.HasIndex("KkjMatrixItemId", "KkjColumnId")
                        .IsUnique();

                    b.ToTable("KkjTargetValues", (string)null);
                });
            ...
            modelBuilder.Entity("HcPortal.Models.PositionColumnMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Position", "KkjColumnId")
                        .IsUnique();

                    b.ToTable("PositionColumnMappings", (string)null);
                });
            ...
            modelBuilder.Entity("HcPortal.Models.KkjColumn", b =>
                {
                    b.HasOne("HcPortal.Models.KkjBagian", "Bagian")
                        .WithMany("Columns")
            ...
            modelBuilder.Entity("HcPortal.Models.KkjTargetValue", b =>
                {
                    b.HasOne("HcPortal.Models.KkjColumn", "KkjColumn")
                        .WithMany("TargetValues")
                        .HasForeignKey("KkjColumnId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
