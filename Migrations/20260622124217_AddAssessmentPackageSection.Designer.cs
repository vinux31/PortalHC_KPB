...
namespace HcPortal.Migrations
{
    ...
    [Migration("20260622124217_AddAssessmentPackageSection")]
    partial class AddAssessmentPackageSection
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HcPortal.Models.AssessmentEditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NewAnswerJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NewAnswerTextSnapshot")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("NewIsPassed")
                        .HasColumnType("bit");

                    b.Property<int?>("NewScore")
                        .HasColumnType("int");

                    b.Property<string>("OldAnswerJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OldAnswerTextSnapshot")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool?>("OldIsPassed")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("AssessmentSessionId", "EditedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_AssessmentEditLogs_SessionId_EditedAt");

                    b.ToTable("AssessmentEditLogs");
                });
            ...
            modelBuilder.Entity("HcPortal.Models.AssessmentPackageSection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("StartNewPage")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.HasIndex("AssessmentPackageId", "SectionNumber")
                        .IsUnique();

                    b.ToTable("AssessmentPackageSections");
                });
            ...
            modelBuilder.Entity("HcPortal.Models.AssessmentSession", b =>
                {
                    ...
                    b.Property<bool>("HasManualGrading")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ExamWindowCloseDate");

                    b.HasIndex("LinkedGroupId");
                    ...
                    b.ToTable("AssessmentSessions", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_AssessmentSession_RenewalChain", "[RenewsSessionId] IS NULL OR [RenewsTrainingId] IS NULL");
                        });
                });
            ...
            modelBuilder.Entity("HcPortal.Models.CoachWorkloadThreshold", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("MaxCoacheesPerCoach")
                        .HasColumnType("int");
                    ...
                    b.ToTable("CoachWorkloadThresholds");
                });
            ...
            modelBuilder.Entity("HcPortal.Models.MaintenanceMode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HcPortal.Models.OrganizationLevelLabel", b =>
                {
                    ...
                    b.ToTable("OrganizationLevelLabels");
                });
            ...
            modelBuilder.Entity("HcPortal.Models.TrainingRecord", b =>
                {
                    ...
                    b.ToTable("TrainingRecords", t =>
                        {
                            t.HasCheckConstraint("CK_TrainingRecord_RenewalChain", "[RenewsTrainingId] IS NULL OR [RenewsSessionId] IS NULL");
                        });
                });
            ...
            modelBuilder.Entity("HcPortal.Models.PackageQuestion", b =>
                {
                    ...
                    b.HasOne("HcPortal.Models.AssessmentPackageSection", "Section")
                        .WithMany("Questions")
